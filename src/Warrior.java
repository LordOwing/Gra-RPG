...
public class Warrior extends Character{
    ...
    public Warrior(String name,  int health, int strength, int dexterity, int intelligence, int energy) {
        this.name = name;
        this.health = health;
    ...
    public void normalAttack(Character enemy) {
        Random r = new Random();
        int dmg = r.nextInt(101) + (2*strength) + intelligence + dexterity;
        enemy.health -= dmg;
    ...
    public boolean superAttack(Character enemy) {
        if(this.energy >= 10){
            Random r = new Random();
            int dmg = r.nextInt(501) + (2*strength) + intelligence + dexterity;
            enemy.health -= dmg;
            this.energy -= 10;
    ...
    public boolean Ult(Character enemy){
        if(this.energy >= 10){
            Random r = new Random();
            int dmg = r.nextInt(1001) + (2*strength) + intelligence + dexterity;
            enemy.health -= dmg;
            this.energy -= 20;
